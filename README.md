...
The repository structure and XML are locally validated. Runtime validation on Unraid is pending; see [test results](docs/test-results.md).
...
Once the image has been published, use this template URL:
